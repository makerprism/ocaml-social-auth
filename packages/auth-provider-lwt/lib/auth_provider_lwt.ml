(** Lwt Runtime Adapter for auth-provider-core *)
...
(** Cohttp_lwt_unix HTTP client for auth-provider-core *)
...
module Types = struct
  type provider = Auth_provider_core.provider =
    | Google
    | GitHub
    | Microsoft
    | Custom of string

  type token_response = Auth_provider_core.token_response = {
    access_token : string;
    token_type : string;
  ...
  type user_info = Auth_provider_core.user_info = {
    provider : provider;
  ...
  type oauth_state = Auth_provider_core.oauth_state = {
    state : string;
  ...
  type provider_config = Auth_provider_core.provider_config = {
    provider : provider;
    client_id : string;
